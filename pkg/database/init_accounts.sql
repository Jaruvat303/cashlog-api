...
('ใช้จ่าย', 'bank', 5000, '["SCB","ไทยพาณิชย์"]'::jsonb, 'scb', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('ลงทุน', 'bank', 5000, '["Dime","เกียรตินาคินภัทร"]'::jsonb, 'dime', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
